...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'HOLD & Out For Delivery', to: 'apps-orders-hold-outfordelivery', action: 'manage', subject: 'order.hold-outfordelivery.page' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Material Requests', to: 'apps-operations-material-req', action: 'manage', subject: 'material_req.page' },
    ],
  },
  {
    title: 'Financials',
